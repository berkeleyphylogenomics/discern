...
# run intrepid
run ("intrepid.py seqfile.fa  %s > intrepid.log; cp intrepid.output.aux intrepid.aux" % pdbid, 'intrepid')
...
run ("%s/rank2discern.pl %s.rank intrepid.aux %s > %s.discern" % (bindir, j, k , j) , 'rank2discern');
