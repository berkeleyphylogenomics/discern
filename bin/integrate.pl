...
# What we (Kimmen et al.) think this means: once all of the scripts complete, the feature vector for each position stores the results
# of those separate scripts.
